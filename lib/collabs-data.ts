...
export const COLLABS: Collab[] = [
  {
    ...
    callNotes: [
      {
        date: '2026-07-03',
        summary: 'Excellent call. Jacob is keen. Much bigger audience than researched. Key: shorts are his money, long-form is premium only.',
        keyPoints: [
          'Channels: 750K IG, 750K TT, 250K YT (not 167K as researched)',
          'Makes $3K per short, 1M+ impressions each',
          'Only 1 long-form every 8 weeks organically — high opportunity cost',
          'Works for the RAAF — needs flexibility, early access needs clearance',
          'All content must include gameplay — no standalone rig shilling',
          'Existing collabs: Thrustmaster, Wind Control (not keen), VKB (bought himself)',
          'Wants: force feedback stick, entry level kits, DCS-branded pack',
          'Open to: War Thunder, VPN, security, data partnerships',
          'Played Flight Sim Expo (Grinelli Designs)',
          'Camera reveal coming — integration opportunity',
          'Asked about affiliates — positive reaction',
          'Accepted 20% management fee',
          'Keen to proceed — sending agreement',
        ],
      },
    ],
    learnings: [
