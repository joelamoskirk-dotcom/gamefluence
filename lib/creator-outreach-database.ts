...
// ── INDONESIA TOP 20 (Priority) ───────────────────────────────────────────────
// MLBB dominant, Free Fire strong, TikTok + YouTube primary platforms

export const indonesiaCreators: OutreachCreator[] = [
  { id: 'id_01', name: 'Jess No Limit', handle: '@jessnolimit', platform: 'youtube', secondaryPlatform: 'tiktok', market: 'ID', followers: 4200000, avgViews: 380000, engagementRate: 7.8, genres: ['Mobile Legends', 'MOBA', 'Variety'], tier: 'mega', estimatedRate: 5000, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Moonton', 'Samsung', 'Shopee'], languages: ['Indonesian'], contentStyle: ['Ranked gameplay', 'Challenges', 'Vlogs'], bestFor: 'MLBB campaigns, mass reach in Indonesia', outreachStatus: 'not_contacted', outreachPriority: 6, aiMatchScore: 70, profileUrl: 'https://youtube.com/@jessnolimit', profileImage: '', description: 'Indonesia MLBB king. 4.2M subs. Likely represented. Good for mega campaigns but expensive.' },
  { id: 'id_02', name: 'Oura Gaming', handle: '@ouragaming', platform: 'youtube', market: 'ID', followers: 2800000, avgViews: 220000, engagementRate: 8.2, genres: ['Mobile Legends', 'MOBA', 'Pro'], tier: 'mega', estimatedRate: 3500, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Moonton', 'Razer'], languages: ['Indonesian'], contentStyle: ['Pro gameplay', 'Guides', 'Tournament'], bestFor: 'MLBB pro-level campaigns, esports activations', outreachStatus: 'not_contacted', outreachPriority: 7, aiMatchScore: 75, profileUrl: 'https://youtube.com/@ouragaming', profileImage: '', description: 'Pro MLBB player/creator. High credibility in competitive scene. Good for esports brand campaigns.' },
  { id: 'id_03', name: 'Zuxxy Gaming', handle: '@zuxxygaming', platform: 'youtube', secondaryPlatform: 'tiktok', market: 'ID', followers: 1900000, avgViews: 150000, engagementRate: 9.1, genres: ['PUBG Mobile', 'Free Fire', 'Shooters'], tier: 'mega', estimatedRate: 2500, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Krafton', 'Garena'], languages: ['Indonesian'], contentStyle: ['Highlights', 'Tips', 'Tournament'], bestFor: 'Shooter campaigns, PUBG/FF launches', outreachStatus: 'not_contacted', outreachPriority: 7, aiMatchScore: 76, profileUrl: 'https://youtube.com/@zuxxygaming', profileImage: '', description: 'Top PUBG Mobile creator in Indonesia. Tournament player. Strong male 16-24 audience.' },
  { id: 'id_04', name: 'Sarah Viloid', handle: '@sarahviloid', platform: 'youtube', secondaryPlatform: 'tiktok', market: 'ID', followers: 1500000, avgViews: 120000, engagementRate: 8.8, genres: ['Mobile Legends', 'Female Gaming', 'Variety'], tier: 'mega', estimatedRate: 2200, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Moonton', 'Wardah'], languages: ['Indonesian'], contentStyle: ['Gameplay', 'Vlogs', 'Collabs'], bestFor: 'Female audience campaigns, MLBB, lifestyle-gaming crossover', outreachStatus: 'not_contacted', outreachPriority: 8, aiMatchScore: 82, profileUrl: 'https://youtube.com/@sarahviloid', profileImage: '', description: 'Top female MLBB creator in Indonesia. Lifestyle crossover. Good for brands targeting female gamers.' },
  { id: 'id_05', name: 'Bang Pen', handle: '@bangpen_id', platform: 'tiktok', market: 'ID', followers: 850000, avgViews: 280000, engagementRate: 12.5, genres: ['Mobile Legends', 'Comedy', 'Clips'], tier: 'macro', estimatedRate: 1200, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Endemic gaming'], languages: ['Indonesian'], contentStyle: ['Funny clips', 'Memes', 'Highlights'], bestFor: 'Viral MLBB content, TikTok-first campaigns', outreachStatus: 'not_contacted', outreachPriority: 9, aiMatchScore: 88, profileUrl: 'https://tiktok.com/@bangpen_id', profileImage: '', description: 'MLBB comedy TikTok. 12.5% engagement. Viral potential. Good for awareness campaigns.' },
  { id: 'id_06', name: 'Racing Indo', handle: '@racingindo', platform: 'youtube', secondaryPlatform: 'tiktok', market: 'ID', followers: 320000, avgViews: 45000, engagementRate: 9.4, genres: ['Racing', 'Asphalt', 'EA FC Mobile'], tier: 'macro', estimatedRate: 600, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Indonesian'], contentStyle: ['Racing gameplay', 'Reviews', 'Tips'], bestFor: 'Racing game campaigns — Gamefluence specialty in ID market', outreachStatus: 'not_contacted', outreachPriority: 10, aiMatchScore: 96, profileUrl: 'https://youtube.com/@racingindo', profileImage: '', description: 'Indonesian racing game creator. No brand deals. Perfect Gamefluence target for racing campaigns.' },
  { id: 'id_07', name: 'FF Clips Indo', handle: '@ffclipsindo', platform: 'tiktok', market: 'ID', followers: 280000, avgViews: 95000, engagementRate: 14.2, genres: ['Free Fire', 'Battle Royale', 'Clips'], tier: 'mid', estimatedRate: 400, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Indonesian'], contentStyle: ['Highlight clips', 'Clutch moments', 'Montages'], bestFor: 'Free Fire campaigns, high-engagement TikTok content', outreachStatus: 'not_contacted', outreachPriority: 9, aiMatchScore: 89, profileUrl: 'https://tiktok.com/@ffclipsindo', profileImage: '', description: 'Free Fire clip account. 14.2% engagement. No brand deals. Affordable and high-impact.' },
  { id: 'id_08', name: 'Drift Jakarta', handle: '@driftjakarta', platform: 'tiktok', market: 'ID', followers: 180000, avgViews: 62000, engagementRate: 15.8, genres: ['Racing', 'Drift', 'CarX'], tier: 'mid', estimatedRate: 280, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Indonesian'], contentStyle: ['Drift clips', 'Racing challenges', 'Car builds'], bestFor: 'Racing drift campaigns — highest engagement racing creator in ID', outreachStatus: 'not_contacted', outreachPriority: 10, aiMatchScore: 97, profileUrl: 'https://tiktok.com/@driftjakarta', profileImage: '', description: '15.8% engagement on racing content. Jakarta based. No representation. MUST SIGN for ID racing campaigns.' },
  { id: 'id_09', name: 'Genshin Indo', handle: '@genshinindo', platform: 'tiktok', secondaryPlatform: 'youtube', market: 'ID', followers: 150000, avgViews: 42000, engagementRate: 11.2, genres: ['Genshin Impact', 'RPG', 'Anime'], tier: 'mid', estimatedRate: 220, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Indonesian'], contentStyle: ['Build guides', 'Pulls', 'Story content'], bestFor: 'Gacha/RPG campaigns, anime game launches in Indonesia', outreachStatus: 'not_contacted', outreachPriority: 8, aiMatchScore: 80, profileUrl: 'https://tiktok.com/@genshinindo', profileImage: '', description: 'Genshin Impact Indonesian creator. Anime aesthetic. Good for HoYoverse campaigns.' },
  { id: 'id_10', name: 'MLBB Tips ID', handle: '@mlbbtipsid', platform: 'tiktok', market: 'ID', followers: 95000, avgViews: 28000, engagementRate: 13.5, genres: ['Mobile Legends', 'Guides', 'Meta'], tier: 'mid', estimatedRate: 150, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Indonesian'], contentStyle: ['Hero guides', 'Meta analysis', 'Tips'], bestFor: 'MLBB educational campaigns, hero launch promotions', outreachStatus: 'not_contacted', outreachPriority: 8, aiMatchScore: 82, profileUrl: 'https://tiktok.com/@mlbbtipsid', profileImage: '', description: 'MLBB tips/guides account. Educational content = high trust. Good for Moonton campaigns.' },
];

// ── PHILIPPINES TOP 15 (Priority) ─────────────────────────────────────────────
// MLBB dominant, English-friendly, high response rate to outreach

export const philippinesCreators: OutreachCreator[] = [
  { id: 'ph_01', name: 'Dogie', handle: '@akosidogie', platform: 'youtube', secondaryPlatform: 'facebook', market: 'PH', followers: 3800000, avgViews: 280000, engagementRate: 7.5, genres: ['Mobile Legends', 'MOBA', 'Esports'], tier: 'mega', estimatedRate: 4000, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Moonton', 'Smart', 'Globe'], languages: ['Filipino', 'English'], contentStyle: ['Commentary', 'Pro analysis', 'Entertainment'], bestFor: 'MLBB campaigns, mass reach in Philippines', outreachStatus: 'not_contacted', outreachPriority: 6, aiMatchScore: 72, profileUrl: 'https://youtube.com/@akosidogie', profileImage: '', description: 'Philippines MLBB legend. Team owner + content creator. Massive reach but likely represented.' },
  { id: 'ph_02', name: 'ChooxTV', handle: '@chooxtv', platform: 'youtube', secondaryPlatform: 'facebook', market: 'PH', followers: 2500000, avgViews: 180000, engagementRate: 8.8, genres: ['Mobile Legends', 'Comedy', 'Variety'], tier: 'mega', estimatedRate: 3000, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Moonton', 'Shopee PH'], languages: ['Filipino', 'English'], contentStyle: ['Comedy gameplay', 'Challenges', 'Collabs'], bestFor: 'Viral MLBB content, entertainment-driven campaigns', outreachStatus: 'not_contacted', outreachPriority: 7, aiMatchScore: 76, profileUrl: 'https://youtube.com/@chooxtv', profileImage: '', description: 'Comedy MLBB creator. High entertainment value. Good for campaigns needing viral reach in PH.' },
  { id: 'ph_03', name: 'Dex Star', handle: '@dexstar_ph', platform: 'tiktok', secondaryPlatform: 'youtube', market: 'PH', followers: 680000, avgViews: 180000, engagementRate: 11.5, genres: ['Valorant', 'FPS', 'Competitive'], tier: 'macro', estimatedRate: 1000, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Riot Games PH'], languages: ['Filipino', 'English'], contentStyle: ['Ranked clips', 'Agent guides', 'Highlights'], bestFor: 'Valorant campaigns in Philippines, FPS game launches', outreachStatus: 'not_contacted', outreachPriority: 8, aiMatchScore: 84, profileUrl: 'https://tiktok.com/@dexstar_ph', profileImage: '', description: 'Filipino Valorant TikTok creator. 11.5% engagement. Growing with Valorant PH scene.' },
  { id: 'ph_04', name: 'Racing PH', handle: '@racingph_official', platform: 'tiktok', market: 'PH', followers: 220000, avgViews: 65000, engagementRate: 13.8, genres: ['Racing', 'EA FC', 'Sports'], tier: 'mid', estimatedRate: 350, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Filipino', 'English'], contentStyle: ['Racing clips', 'Sports gameplay', 'Challenges'], bestFor: 'Racing/sports campaigns in Philippines — Gamefluence specialty', outreachStatus: 'not_contacted', outreachPriority: 10, aiMatchScore: 95, profileUrl: 'https://tiktok.com/@racingph_official', profileImage: '', description: 'Filipino racing/sports creator. No brand deals. English-friendly. Perfect for Gamefluence pilot.' },
  { id: 'ph_05', name: 'ML Queen PH', handle: '@mlqueenph', platform: 'tiktok', secondaryPlatform: 'youtube', market: 'PH', followers: 185000, avgViews: 52000, engagementRate: 12.2, genres: ['Mobile Legends', 'Female Gaming', 'MOBA'], tier: 'mid', estimatedRate: 300, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Filipino', 'English'], contentStyle: ['Gameplay', 'Funny moments', 'Duo content'], bestFor: 'Female MLBB audience, brand-safe campaigns', outreachStatus: 'not_contacted', outreachPriority: 9, aiMatchScore: 88, profileUrl: 'https://tiktok.com/@mlqueenph', profileImage: '', description: 'Female MLBB creator in Philippines. No representation. English-speaking. Easy to work with.' },
  { id: 'ph_06', name: 'Pinoy Drift', handle: '@pinoydrift', platform: 'tiktok', market: 'PH', followers: 120000, avgViews: 42000, engagementRate: 15.5, genres: ['Racing', 'Drift', 'Mobile Racing'], tier: 'mid', estimatedRate: 180, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Filipino', 'English'], contentStyle: ['Drift clips', 'Racing highlights', 'Challenges'], bestFor: 'Racing campaigns PH — highest engagement racing creator', outreachStatus: 'not_contacted', outreachPriority: 10, aiMatchScore: 98, profileUrl: 'https://tiktok.com/@pinoydrift', profileImage: '', description: '15.5% engagement. Racing drift specialist. $180/campaign. English-speaking. SIGN IMMEDIATELY.' },
  { id: 'ph_07', name: 'Wild Rift PH', handle: '@wildriftph_tips', platform: 'tiktok', market: 'PH', followers: 85000, avgViews: 25000, engagementRate: 11.8, genres: ['Wild Rift', 'MOBA', 'Guides'], tier: 'micro', estimatedRate: 120, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Filipino', 'English'], contentStyle: ['Champion guides', 'Tips', 'Meta analysis'], bestFor: 'Wild Rift/MOBA campaigns, educational content', outreachStatus: 'not_contacted', outreachPriority: 8, aiMatchScore: 79, profileUrl: 'https://tiktok.com/@wildriftph_tips', profileImage: '', description: 'Wild Rift tips account. Educational content. Good for Riot Games PH campaigns.' },
];

// ── THAILAND TOP 10 (Priority) ────────────────────────────────────────────────
// Valorant + RoV dominant, YouTube + Twitch stronger than other SEA markets

export const thailandCreators: OutreachCreator[] = [
  { id: 'th_01', name: 'KadoomVAL', handle: '@kadoomval', platform: 'youtube', secondaryPlatform: 'twitch', market: 'TH', followers: 520000, avgViews: 65000, engagementRate: 8.5, genres: ['Valorant', 'FPS', 'Competitive'], tier: 'macro', estimatedRate: 1500, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Riot Games TH'], languages: ['Thai', 'English'], contentStyle: ['Ranked gameplay', 'Agent guides', 'Tournament'], bestFor: 'Valorant campaigns Thailand, FPS game launches', outreachStatus: 'not_contacted', outreachPriority: 9, aiMatchScore: 87, profileUrl: 'https://youtube.com/@kadoomval', profileImage: '', description: 'Top Thai Valorant creator. 520K subs. Growing fast. May not be represented yet — check.' },
  { id: 'th_02', name: 'RoV Thai Pro', handle: '@rovthaipro', platform: 'youtube', secondaryPlatform: 'facebook', market: 'TH', followers: 380000, avgViews: 48000, engagementRate: 9.2, genres: ['RoV (Arena of Valor)', 'MOBA', 'Esports'], tier: 'macro', estimatedRate: 1200, brandSafe: true, hasWorkedBrands: true, knownBrands: ['Garena TH'], languages: ['Thai'], contentStyle: ['Pro gameplay', 'Guides', 'Meta analysis'], bestFor: 'RoV/MOBA campaigns in Thailand', outreachStatus: 'not_contacted', outreachPriority: 8, aiMatchScore: 82, profileUrl: 'https://youtube.com/@rovthaipro', profileImage: '', description: 'RoV (Arena of Valor) specialist. Thailand\'s version of Lien Quan. Strong in Thai MOBA scene.' },
  { id: 'th_03', name: 'Thai Racing King', handle: '@thairacingking', platform: 'tiktok', secondaryPlatform: 'youtube', market: 'TH', followers: 195000, avgViews: 58000, engagementRate: 13.2, genres: ['Racing', 'KartRider', 'Sports'], tier: 'mid', estimatedRate: 450, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Thai', 'English'], contentStyle: ['Racing clips', 'KartRider content', 'Challenges'], bestFor: 'Racing campaigns Thailand — premium market, high ARPU audience', outreachStatus: 'not_contacted', outreachPriority: 10, aiMatchScore: 96, profileUrl: 'https://tiktok.com/@thairacingking', profileImage: '', description: 'Thai racing creator. KartRider Rush+ focus. No brand deals. Thailand = premium spending audience.' },
  { id: 'th_04', name: 'Genshin TH', handle: '@genshinth_official', platform: 'tiktok', market: 'TH', followers: 165000, avgViews: 45000, engagementRate: 11.8, genres: ['Genshin Impact', 'RPG', 'Anime'], tier: 'mid', estimatedRate: 380, brandSafe: true, hasWorkedBrands: true, knownBrands: ['HoYoverse TH'], languages: ['Thai'], contentStyle: ['Build guides', 'Event coverage', 'Pulls'], bestFor: 'Gacha/RPG campaigns in Thailand premium market', outreachStatus: 'not_contacted', outreachPriority: 8, aiMatchScore: 83, profileUrl: 'https://tiktok.com/@genshinth_official', profileImage: '', description: 'Thai Genshin creator. Has worked with HoYoverse. Good for RPG campaigns in premium TH market.' },
  { id: 'th_05', name: 'Valorant TH Clips', handle: '@valthclips', platform: 'tiktok', market: 'TH', followers: 110000, avgViews: 35000, engagementRate: 14.5, genres: ['Valorant', 'FPS', 'Clips'], tier: 'mid', estimatedRate: 200, brandSafe: true, hasWorkedBrands: false, knownBrands: [], languages: ['Thai'], contentStyle: ['Clutch clips', 'Highlights', 'Funny moments'], bestFor: 'Valorant TikTok campaigns Thailand', outreachStatus: 'not_contacted', outreachPriority: 9, aiMatchScore: 86, profileUrl: 'https://tiktok.com/@valthclips', profileImage: '', description: 'Valorant clip account. 14.5% engagement. No brand deals. Affordable for TH market entry.' },
];

// ── COMBINED GETTER ───────────────────────────────────────────────────────────

export function getAllCreators(): OutreachCreator[] {
  return [...vietnamCreators, ...indonesiaCreators, ...philippinesCreators, ...thailandCreators];
}

export function getCreatorsByMarketFull(market: OutreachCreator['market']): OutreachCreator[] {
  switch (market) {
    case 'VN': return vietnamCreators;
    case 'ID': return indonesiaCreators;
    case 'PH': return philippinesCreators;
    case 'TH': return thailandCreators;
    default: return [];
  }
}
